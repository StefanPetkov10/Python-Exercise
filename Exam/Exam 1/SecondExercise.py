...
car1 = Car('Audi', 'A4', 8000, 'black', 2007)
...
sorted_cars = sort_by_price(cars)
...
def list_by_brand2(car_brand_for_search):
    list_brand2 = [car for car in cars if car.car_brand == car_brand_for_search]
    return list_brand2
